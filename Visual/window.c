...
#include "../Game_mechanics/minMax.c"
#include "../Game_mechanics/game.c"
#include "../Game_mechanics/movePiece.c"
GdkColor prevColor;
			...
			GtkLabel *labelBoard[][8])
{
    ...
    if (event->type == GDK_BUTTON_PRESS)
    {
        if (!clicks) {
            ...
            int u = movePiece(tab,mov.currRow*8+mov.currCol, mov.nextRow*8+mov.nextCol);
            if (u) 
            {
